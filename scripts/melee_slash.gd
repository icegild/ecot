extends Node2D
# ─────────────────────────────────────────────────────────────────────
#  melee_slash.gd  –  Texture-based slash VFX tinted by skin colors
#  Godot 4.7  |  Spawned by player_controller.gd on melee (X key)
# ─────────────────────────────────────────────────────────────────────
#
...
const SWEEP_ANGLE_MAX: float = 90.0    # degrees the slash rotates through
const SCALE_START: float = 0.7
const SCALE_PEAK: float = 1.15
const SCALE_END: float = 0.95
...
func _ready() -> void:
        ...
        var pos := Vector2(_facing * 12.0, -10.0)
